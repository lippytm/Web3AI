...
class TelemetryStub:
    ...
    def __init__(self, enabled: bool = False, endpoint: str = "", service_name: str = "web3ai-backend"):
    ...
    def _setup_telemetry(self):
        ...
        trace, TracerProvider, BatchSpanProcessor, ConsoleSpanExporter, _ = components
...
def create_telemetry(enabled: bool = False, endpoint: str = "", service_name: str = "web3ai-backend") -> TelemetryStub:
